...
namespace UziRubiksCube
	...
	public class Cube
		...
		/// </summary>
		private static readonly Random RandomMove = new();
		...
		/// <returns></returns>
		private static SolutionStep SolveYellowCornersPosition
				(
				StepCtrl Step,
				int Match,
				int Rotate,
		...
		/// <returns>Solve step</returns>
		private static SolutionStep LookForOneYellowCornerMatch
				(
				int[] FaceArrayArg
				)
			{
		...
		/// <param name="FaceArrayArg">Face array</param>
		/// <returns>Solve step</returns>
		private static SolutionStep LookForOneYellowEdgeMatch
				(
				int[] FaceArrayArg
				)
			{
